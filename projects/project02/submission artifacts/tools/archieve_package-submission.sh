...
# still work. It is no longer the canonical Project02 deploy path. The
# canonical deploy path is the Docker image built by
# `projects/project02/server/Dockerfile`.
#
