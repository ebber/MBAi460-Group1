// projects/project02/server/src/photoapp-core/middleware/error.js
//
...
// local core `createErrorMiddleware` is the Project 02 source; surfaces diverge
// only via DI config.
//
...
function createErrorMiddleware({
  ...
  return function errorMiddleware(err, req, res, _next) {
