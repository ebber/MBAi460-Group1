...
const { createErrorMiddleware } = require('../../../src/photoapp-core/middleware/error');

// Construct the default-configured middleware (Part 03 mapping). The factory
// pattern is the post-extraction shape; defaults reproduce Part 03's exact
// pre-extraction behaviour, so the tests below operate on the same effective
// middleware as before the move.
