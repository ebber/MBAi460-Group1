// projects/project02/server/tests/unit/photoapp_core/schemas/envelopes.test.js
//
...
const { successResponse, errorResponse } = require('../../../src/photoapp-core/schemas/envelopes');
