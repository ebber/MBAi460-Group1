// projects/project02/server/tests/unit/photoapp_core/exports-shape.test.js
//
// Snapshot of the Project 02 local core public exports surface. Catches accidental
// rename / removal of public API at the cheapest possible moment — in the
// Project 02 split CI, before the consumers' boot-time errors hours later.
//
...
test('schemas.envelopes exports', () => {
  expect(Object.keys(lib.schemas.envelopes).sort()).toEqual(['errorResponse', 'successResponse']);
});
