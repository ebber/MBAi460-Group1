...
3. Cross-reference `Andrew-MVP-Integration.md` rows 62–65, 84, 85, 87, 96 for the specific audit-row-level commitments.
...
- **Audit cross-refs:** rows 62-65 (Asset Detail Photo layout + data + states + acceptance), 84 (FR-ASSET-4 inline rename), 85 (FR-ASSET-5 per-asset delete), 87 (FR-ASSET-7 multi-select), 96 (FR-AI-6 manual re-run) in `MetaFiles/Andrew-MVP-Integration.md`
