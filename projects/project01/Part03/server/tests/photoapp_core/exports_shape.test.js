// projects/project01/Part03/server/tests/photoapp_core/exports-shape.test.js
//
...
test("repositories.* exports (Phase 0.3 CL9 reconciliation)", () => {
  expect(Object.keys(lib.repositories).sort()).toEqual([
    "assets",
    "labels",
    "users",
  ]);
...
test("repositories.users exports", () => {
  expect(Object.keys(lib.repositories.users).sort()).toEqual([
    "countAll",
    "findAll",
    "findById",
  ]);
